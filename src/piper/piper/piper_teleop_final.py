...
class PiperTeleopGamepad(Node):
    def __init__(self):
        super().__init__('piper_teleop_final')
        # --- Publishers ---
    ...
    def _trigger_home_once(self):
        ...
        self.home_timer.cancel()  # :raute_blau_klein: Detiene el timer, no se vuelve a llamar
    # ============================================================
    ...
    def mode_callback(self, msg: String):
        ...
        if mode == "cartesian" and not self.mode_cart:
            ...
            self.get_logger().info(":satellit: Modo cambiado externamente a CARTESIANO")
        elif mode == "joint" and self.mode_cart:
            self.mode_cart = False
            self.external_mode_override = True
            self.get_logger().info(":satellit: Modo cambiado externamente a ARTICULAR")
    # ============================================================
    def loop(self):
        pygame.event.pump()
